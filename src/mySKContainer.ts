...
import { SKMouseEvent } from "simplekit/imperative-mode";
import { invalidateLayout } from "simplekit/imperative-mode";
...
export class MySKContainer extends SKElement {
  ...
  private _children: MySKLabel[] = [];
  get children(): readonly MySKLabel[] {
    return this._children;
  }

  addChild(element: MySKLabel) {
    this._children.push(element);
    invalidateLayout();
  }

  removeChild(element: MySKLabel) {
