import { SKKeyboardEvent, SKMouseEvent } from "simplekit/imperative-mode";
import { measureText } from "simplekit/utility";
import { requestKeyboardFocus } from "simplekit/imperative-mode";
...
export class MySKTextfield extends SKElement {
